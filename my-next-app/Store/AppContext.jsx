...
function AppContextProvider({ children }) {
    ...
    async function Fetch_HR_Jobs_Listing() {
      try {
        const response = await fetch(
          "http://localhost:4001/api/jobRoutes/getMyJobs",
  ...
  useEffect(() => {
    async function fetchAllJobs() {
      try {
        const response = await fetch(
          "http://localhost:4001/api/jobRoutes/getAllJobs",
          {
            method: "GET",
            credentials: "include",
          }
  ...
  useEffect(() => {
    async function FetchCompaniesList() {
      try {
        const response = await fetch(
          "http://localhost:4001/api/userRoutes/FetchCompaniesList",
          {
            method: "GET",
            credentials: "include",
          }
        ...
        //       "http://localhost:4001/api/jobRoutes/FindJobByID/:id"
        //     );
        //   });
        // }
  ...
  async function SubmitJobApplication(
    ...
    try {
      ...
      const response = await fetch(
        "http://localhost:4001/api/applicationRoutes/postApplication",
        {
          method: "POST",
          credentials: "include",
          body: formData,
