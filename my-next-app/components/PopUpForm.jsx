...
function PopUpForm({ ApplicationId, Application }) {
  ...
  async function handleRejectBtn() {
    try {
      ...
      const response = await fetch(
        `https://nextjs-job-seeking-app-g4py.onrender.com/api/applicationRoutes/jobSeekerDeleteApplication/${ApplicationId}`,
        {
          method: "DELETE",
          credentials: "include",
        }
  ...
  async function handleAcceptBtn() {
    try {
      const response = await fetch(
        `https://nextjs-job-seeking-app-g4py.onrender.com/api/applicationRoutes/AcceptJobApplication/${ApplicationId}`,
        {
          method: "POST",
          credentials: "include",
        }
