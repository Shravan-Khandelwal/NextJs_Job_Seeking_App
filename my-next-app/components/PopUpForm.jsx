...
function PopUpForm({ ApplicationId, Application }) {
  ...
  async function handleRejectBtn() {
    try {
      ...
      const response = await fetch(
        `http://localhost:4001/api/applicationRoutes/jobSeekerDeleteApplication/${ApplicationId}`,
        {
          method: "DELETE",
          credentials: "include",
        }
  ...
  async function handleAcceptBtn() {
    try {
      const response = await fetch(
        `http://localhost:4001/api/applicationRoutes/AcceptJobApplication/${ApplicationId}`,
        {
          method: "POST",
          credentials: "include",
        }
